	...
	: Super(PCIP)
{
	...
	CollisionComp->OnComponentBeginOverlap.AddDynamic(this, &AThesisTestProjectile::OnOverlap);		// set up a notification for when this component overlaps something
